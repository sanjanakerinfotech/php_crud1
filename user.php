            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="<?php echo get_site_url('user.php?action=status&user_id='.$users['id'].'&user_status='.$users['status'] ) ?>">
                        <i class="fa<?php echo (isset($users['status']) && $users['status']=='1') ? 's' : 'r' ?> fa-check-circle"></i></a>
                    </td>
                    <td class="text-center">
